...
public class WordAdapter extends ArrayAdapter<Word1> {
    ...
    public WordAdapter(Activity context, ArrayList<Word1> words, int background_color ) {
        // Here, we initialize the ArrayAdapter's internal storage for the context and the list.
        // the second argument is used when the ArrayAdapter is populating a single TextView.
        // Because this is a custom adapter for two TextViews and an ImageView, the adapter is not
        // going to use this second argument, so it can be any value. Here, we used 0.
        super(context, 0, words);
        mcolorRId=background_color;
    }
    @NonNull
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View colorContainer=listItemView.findViewById(R.id.color_container);
        ...
        imgView.setImageResource(currentWord.getImgRId());
        }
        else{
